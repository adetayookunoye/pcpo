...
The combination of stream-function parameterization with conditional VAE ensures that all samples from the learned distribution are physically valid. We empirically study calibration and diversity of the predictive distribution on PDEBench.
